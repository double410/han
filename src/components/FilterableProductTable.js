...
class SearchBar extends Component {
    ...
    render() {
        ...
        return(
            <Form>
                <Search type='text' placeholder='Search...' width='4' value={prodName} onChange={this.handleChange} options={lst_stock}/>
                <Checkbox toggle label='Only show products in stock' checked={hasStock} onChange={this.handleClick} />
            </Form>
        );
    }
}
